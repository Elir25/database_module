...
select address, postcode from customers where name = 'Melinda Marsh';
select name from hotels where postcode = 'DGQ127';
select name from hotels where rooms > 11;
select name from hotels where rooms > 6 AND rooms < 15;
select name from hotels where rooms = 20 or rooms = 10;
